  ...
  if (!overview) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-text-secondary">Regional data not available</p>
        <p className="text-xs text-text-secondary mt-2">
          Make sure your account has a region assigned. Contact super admin.
        </p>
      </div>
    );
  }

  const { region, schools, geography, students, teachers, classes, attendance, assessments } = overview;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <MapPin className="h-6 w-6 text-akoma-green" />
            <h1 className="text-2xl font-bold text-text">{region.name} Region</h1>
          </div>
          <p className="text-text-secondary">
            Regional overview of all districts and schools
          </p>
        </div>
      ...
      <div className="bg-linear-to-r from-akoma-green to-green-700 rounded-2xl p-6 text-white">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-semibold">Region at a Glance</h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="bg-white/10 backdrop-blur rounded-lg p-4">
            <div className="flex items-center gap-2 mb-1">
              <Building2 className="h-4 w-4 text-white/80" />
              <p className="text-xs text-white/80">Districts</p>
            </div>
            <p className="text-2xl font-bold">{geography.districts}</p>
          </div>
          <div className="bg-white/10 backdrop-blur rounded-lg p-4">
            <div className="flex items-center gap-2 mb-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <p className="text-3xl font-bold text-text">{geography.districts}</p>
          <p className="text-sm text-text-secondary mt-1">Districts</p>
          <p className="text-xs text-text-secondary mt-2">
            Across {region.name} region
          </p>
        </Link>
            ...
            {topSchools.atRisk.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-text-secondary">
                  🎉 No at-risk schools in this region
                </p>
              </div>
            ) : (
              <div className="divide-y divide-gray-50">
      ...
      {/* ============================================
          DISTRICTS PREVIEW
          ============================================ */}
      {geography.districtNames && geography.districtNames.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-text flex items-center gap-2">
              <Building2 className="h-5 w-5 text-akoma-green" />
              Districts in {region.name}
            </h2>
          ...
          <div className="flex flex-wrap gap-2">
            {geography.districtNames.map((district) => (
              <span
                key={district}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-50 text-sm text-text-secondary"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium text-text">Districts</p>
              <p className="text-xs text-text-secondary truncate">
                {geography.districts} districts
              </p>
            </div>
          </Link>
