...
import { getPendingApplications } from '@/lib/services/adminService';

// Navigation items without hardcoded badge
const navItems = [
  {
    section: 'Main',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { 
        ...
        icon: ClipboardCheck,
        badgeKey: 'pending' // Will be replaced with real count
      },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { 
        ...
        href: '/platform/curriculum/create', 
        icon: PlusCircle 
      },
    ]
  },
    ...
    const fetchPendingCount = async () => {
      try {
        ...
        if (data) {
          ...
          const submitted = apps.filter((a: any) => a.applicationStatus === 'submitted').length;
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="hidden md:flex items-center flex-1 max-w-md mx-4">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search schools, users, curriculum..."
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  ...
                  <p className="text-xs text-text-secondary capitalize">Super Admin</p>
                </div>
                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <p className="text-xs text-akoma-green mt-0.5 capitalize">Super Admin</p>
                    </div>
                    <Link
                      href="/platform/settings"
            ...
            <div key={section.section} className="mb-4">
              ...
              <div className="space-y-1">
                {section.items.map((item) => {
                  ...
                  // Get badge count - real data for pending
