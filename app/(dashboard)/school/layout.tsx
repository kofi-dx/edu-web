...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Applications', href: '/school/student-applications', icon: UserPlus },
      { label: 'Teachers', href: '/school/teachers', icon: GraduationCap },
      { label: 'Classes', href: '/school/classes', icon: BookOpen },
      { label: 'Parents', href: '/school/parents', icon: UserPlus },
    ]
  },
  {
    section: 'Operations',
    items: [
      { label: 'Attendance', href: '/school/attendance', icon: Calendar },
      { label: 'Devices', href: '/school/attendance/devices', icon: QrCode },
    ]
  },
  {
    section: 'Analytics',
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  ...
                  <p className="text-xs text-text-secondary capitalize">School Admin</p>
                </div>
                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <p className="text-xs text-akoma-green mt-0.5 capitalize">School Admin</p>
                    </div>
                    <Link
            ...
            <div key={section.section} className="mb-4">
              ...
              <div className="space-y-1">
                {section.items.map((item) => {
                  const isActive = 
                    (item.href === '/school' && pathname === '/school') || 
