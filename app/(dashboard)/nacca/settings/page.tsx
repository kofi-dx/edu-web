...
export default function NaccaSettingsPage() {
  ...
  const [profile, setProfile] = useState({
    ...
    office: 'NaCCA Headquarters',
    position: 'Curriculum Officer',
  });

  // Notifications state
  const [notifications, setNotifications] = useState<NotificationSettings>({
    emailOnNewCurriculum: true,
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem('nacca_settings');
      if (saved) {
      ...
      <div className="bg-linear-to-r from-akoma-green to-green-700 rounded-xl p-5 text-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold">NaCCA Curriculum Admin</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="NaCCA Headquarters"
                  className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-akoma-green focus:border-transparent outline-none transition-all"
                />
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              {[
                {
                  key: 'emailOnNewCurriculum' as const,
                  label: 'New curriculum activity',
                  desc: 'Get notified when new curricula, subjects, or lessons are added'
                },
                {
                  key: 'emailWeeklyReport' as const,
                  label: 'Weekly content summary',
                  desc: 'Receive a weekly email with publishing progress'
                },
                {
                  key: 'emailMonthlyReport' as const,
                  label: 'Monthly analytics report',
                  desc: 'Full monthly report with coverage metrics'
                },
                {
                  key: 'emailCriticalAlerts' as const,
                  label: 'Coverage alerts',
                  desc: 'Important notifications about content gaps'
                },
              ].map((item) => (
                <label
                  key={item.key}
          ...
          <div className="pt-6 border-t border-gray-100">
            ...
            <label className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
              ...
              />
              <div className="flex-1">
                <p className="text-sm font-medium text-text">Critical coverage alerts via SMS</p>
                <p className="text-xs text-text-secondary">
                  Get urgent notifications when content is missing (data rates may apply)
                </p>
              </div>
            </label>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setPreferences({ ...preferences, defaultExportFormat: e.target.value as any })}
                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-akoma-green focus:border-transparent outline-none transition-all bg-white"
              >
