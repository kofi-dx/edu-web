...
export default function GESSettingsPage() {
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem('ges_settings');
      if (saved) {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g., Ministry of Education HQ"
                  className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-akoma-green focus:border-transparent outline-none transition-all"
                />
              </div>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Get notified when a new school applies for registration'
                },
                {
                  key: 'emailWeeklyReport' as const,
                  label: 'Weekly performance summary',
                  desc: 'Receive a weekly email with key metrics'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Important notifications about at-risk schools'
                },
              ].map((item) => (
                <label
                  key={item.key}
