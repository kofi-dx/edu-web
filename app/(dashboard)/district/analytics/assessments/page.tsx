...
import {
  getDistrictAssessmentPerformance,
...
export default function DistrictAssessmentsPage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const [assessmentsData, schoolsData] = await Promise.all([
        getDistrictAssessmentPerformance(range),
        getSchoolsInDistrict({ limit: 100 })
      ]);
  ...
  // Sort subjects by performance for highlights
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-secondary">
            Subject performance across your district
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-lg font-semibold">District Pass Rate</h2>
            </div>
            ...
            {schools.slice(0, 6).map((school) => (
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-akoma-green/10 flex items-center justify-center shrink-0">
                  <Landmark className="h-4 w-4 text-akoma-green" />
                </div>
                <div className="flex-1 min-w-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-red-50 rounded-lg border border-red-100">
              ...
              <p className="text-2xl font-bold text-red-600 mt-1">
                {topSubjects[topSubjects.length - 1]?.averageScore || 0}%
              </p>
            </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-xs font-semibold text-blue-700">District Average</p>
              </div>
